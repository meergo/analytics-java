...
import com.meergo.analytics.gson.AutoValueAdapterFactory;
import com.meergo.analytics.gson.ISO8601DateAdapter;
import com.meergo.analytics.http.MeergoService;
import com.meergo.analytics.internal.AnalyticsClient;
import com.meergo.analytics.internal.AnalyticsVersion;
...
/**
 * The entry point into the Meergo for Java library.
 *
 * <p>The idea is simple: one pipeline for all your data. Meergo is the single hub to collect,
 * translate and route your data with the flip of a switch.
 *
 * <p>Analytics for Java will automatically batch events and upload it periodically to Meergo's
 * servers for you. You only need to instrument Meergo once, then flip a switch to install new
 * tools.
 *
...
public class Analytics {
   ...
   *
   * @param writeKey Your project write key available on the Meergo dashboard.
   */
  public static Builder builder(String writeKey) {
    return new Builder(writeKey);
  }

  /** Enqueue the given message to be uploaded to Meergo's servers. */
  ...
  public static class Builder {
     ...
     * https://api.example.com} by default.
     */
    ...
    public Analytics build() {
      ...
      MeergoService meergoService = restAdapter.create(MeergoService.class);
