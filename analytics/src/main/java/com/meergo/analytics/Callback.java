...
public interface Callback {
  /**
   * Invoked when the message is successfully uploaded to Meergo.
   *
   * <p>Note: The Meergo HTTP API itself is asynchronous, so this doesn't indicate whether the
   * message was sent to all integrations or not — just that the message was sent to the Meergo API
